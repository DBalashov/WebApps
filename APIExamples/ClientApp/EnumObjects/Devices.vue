            ...
            <div class="col-4 pt-2">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="example">
<pre>
$.post("{{ExternalSettings.Urls.Service}}/EnumDevices",
{
            ...
            <div class="col-8">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="grid-content" role="tabpanel">
                        <div class="row items">
                            <table class="table" v-if="store.state.Devices.Groups.length">
                                <tr>
                        ...
                        <div class="row items">
                            <table class="table" v-if="store.state.Devices.Items.length">
                                <tr>
