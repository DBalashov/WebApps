            ...
            <div class="col-4 pt-2">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="example">
<pre>
$.post("{{ExternalSettings.Urls.Service}}/EnumParameters",
{
                                ...
                                <tr v-for="o in Items">
                                    ...
                                    <td>
                                        <table style="width:100%;">
                                            <tr>
                                                <td style="border:none"><parameter-list :Items="o.OnlineParams" Caption="Table parameters"/></td>
                                                <td style="border:none"><parameter-list :Items="o.TripsParams" Caption="Trip parameters"/></td>
                                                <td style="border:none"><parameter-list :Items="o.FinalParams" Caption="Final parameters"/></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
<script src="./Parameters.ts"></script>