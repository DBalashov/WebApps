                        ...
                        <div class="col-12">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input type="text" class="form-control" id="tripParams" v-model="onlineParams">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="tab-pane fade show active" id="grid-content" role="tabpanel">
                        <div class="items-2x" style="overflow-x:hidden">
                            <div class="row mb-3 trip-item" v-for="o in Items">
                                <car-header :Item="o"/>
                                <trip-table-items :Items="o.Trips" @show-total="showTotal"/>
                            </div>
                        </div>
...
<script src="./GetTripTables.ts"></script>