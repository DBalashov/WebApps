        ...
        <div class="row">
            <div class="col-4 pt-2">
                <fieldset>
                    ...
                    <div v-if="store.state.Geofences.Checked.length" class="items-list">
                        <div v-for="o in store.state.Geofences.Checked">
                            <input type="checkbox" :id="o.ID" v-model="o.Checked"/><label :for="o.ID">{{o.Name}}<span>{{o.Data}}</span></label>
                        </div>

                    </div>
                    <a href="javascript:void(0)" class="btn btn-primary mb-2" @click="updateItems" v-else>call EnumGeofences first</a>
                </fieldset>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="example">
<pre>
$.post("{{ExternalSettings.Urls.Service}}/GetGFProperties",
{
